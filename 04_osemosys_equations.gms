...
* # Constraints #
* ####################
equation EQ_SpecifiedDemand1(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
...
* ############### Storage #############
*
equation S1_StorageCharge(STORAGE,YEAR2,TIMESLICE,ECONOMYrun);
...
equation S2_StorageDischarge(STORAGE,YEAR2,TIMESLICE,ECONOMYrun);
...
equation S3_NetStorageCharge(STORAGE,YEAR2,TIMESLICE,ECONOMYrun);
S3_NetStorageCharge(s,y,l,r).. NetStorageCharge(s,y,l,r) =e= StorageCharge(s,y,l,r) - StorageDischarge(s,y,l,r);

equation S4_StorageLevelAtInflection(BOUNDARY_INSTANCES,STORAGE,ECONOMYrun);
...
equation S5_StorageLowerLimit(BOUNDARY_INSTANCES,STORAGE,ECONOMYrun);
S5_StorageLowerLimit(b,s,r).. StorageLevel(s,b,r) =g= StorageLowerLimit(r,s);

equation S6_StorageUpperLimit(BOUNDARY_INSTANCES,STORAGE,ECONOMYrun);
S6_StorageUpperLimit(b,s,r).. StorageLevel(s,b,r) =l= StorageUpperLimit(r,s);
*
* ############### Capacity Adequacy A #############
*
equation CBa1_TotalNewCapacity(YEAR2,ACTIVITY,ECONOMYrun);
...
* ############### Capacity Adequacy B #############
*
equation CBb1_PlannedMaintenance(YEAR2,ACTIVITY,ECONOMYrun);
...
equation EBa1_RateOfFuelProduction1(YEAR2,TIMESLICE,FLOW,ACTIVITY,MODE_OF_OPERATION,ECONOMYrun);
...
equation EBa2_RateOfFuelProduction2(YEAR2,TIMESLICE,FLOW,ACTIVITY,ECONOMYrun);
...
equation EBa3_RateOfFuelProduction3(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
...
equation EBa4_RateOfFuelUse1(YEAR2,TIMESLICE,FLOW,ACTIVITY,MODE_OF_OPERATION,ECONOMYrun);
...
equation EBa5_RateOfFuelUse2(YEAR2,TIMESLICE,FLOW,ACTIVITY,ECONOMYrun);
EBa5_RateOfFuelUse2(y,l,f,a,r).. sum(m, RateOfUseByTechnologyByMode(y,l,a,m,f,r)) =e= RateOfUseByTechnology(y,l,a,f,r);

equation EBa6_RateOfFuelUse3(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
...
equation EBa7_EnergyBalanceEachTS1(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
EBa7_EnergyBalanceEachTS1(y,l,f,r).. RateOfProduction(y,l,f,r)*YearSplit(l,y) =e= Production(y,l,f,r);

equation EBa8_EnergyBalanceEachTS2(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
EBa8_EnergyBalanceEachTS2(y,l,f,r).. RateOfUse(y,l,f,r)*YearSplit(l,y) =e= Use(y,l,f,r);

equation EBa9_EnergyBalanceEachTS3(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
EBa9_EnergyBalanceEachTS3(y,l,f,r).. RateOfDemand(y,l,f,r)*YearSplit(l,y) =e= Demand(y,l,f,r);

equation EBa10_EnergyBalanceEachTS4(ECONOMY,ECONOMYrun2,TIMESLICE,FLOW,YEAR2);
EBa10_EnergyBalanceEachTS4(r,rr,l,f,y).. Trade(r,rr,l,f,y) =e= -Trade(rr,r,l,f,y);

equation EBa11_EnergyBalanceEachTS5(YEAR2,TIMESLICE,FLOW,ECONOMYrun);
...
*
equation Acc1_FuelProductionByTechnology(YEAR2,TIMESLICE,ACTIVITY,FLOW,ECONOMYrun);
...
equation Acc2_FuelUseByTechnology(YEAR2,TIMESLICE,ACTIVITY,FLOW,ECONOMYrun);
Acc2_FuelUseByTechnology(y,l,a,f,r).. RateOfUseByTechnology(y,l,a,f,r) * YearSplit(l,y) =e= UseByTechnology(y,l,a,f,r);

equation Acc3_AverageAnnualRateOfActivity(YEAR2,ACTIVITY,MODE_OF_OPERATION,ECONOMYrun);
...
* ############### Captial Costs #############
*
equation CC1_UndiscountedCapitalInvestment(YEAR2,ACTIVITY,ECONOMYrun);
CC1_UndiscountedCapitalInvestment(y,a,r).. CapitalCost(r,a,y) * NewCapacity(y,a,r) =e= CapitalInvestment(y,a,r);

equation CC2_DiscountingCapitalInvestmenta(YEAR2,ACTIVITY,ECONOMYrun);
...
* ##############* Salvage Value #############
*
equation SV1_SalvageValueAtEndOfPeriod1(YEAR2,ACTIVITY,ECONOMYrun);
...
equation SV2_SalvageValueAtEndOfPeriod2(YEAR2,ACTIVITY,ECONOMYrun);
...
equation SV3_SalvageValueAtEndOfPeriod3(YEAR2,ACTIVITY,ECONOMYrun);
SV3_SalvageValueAtEndOfPeriod3(y,a,r)$(YearVal(y) + OperationalLife(r,a)-1 <= smax(yy, YearVal(yy)))..
SalvageValue(y,a,r) =e= 0;

equation SV4_SalvageValueDiscToStartYr(YEAR2,ACTIVITY,ECONOMYrun);
...
* ############### Operating Costs #############
*
equation OC1_OperatingCostsVariable(YEAR2,ACTIVITY,ECONOMYrun);
...
equation OC2_OperatingCostsFixedAnnual(YEAR2,ACTIVITY,ECONOMYrun);
OC2_OperatingCostsFixedAnnual(y,a,r).. TotalCapacityAnnual(y,a,r)*FixedCost(r,a,y) =e= AnnualFixedOperatingCost(y,a,r);

equation OC3_OperatingCostsTotalAnnual(YEAR2,ACTIVITY,ECONOMYrun);
...
equation OC4_DiscountedOperatingCostsTotalAnnual(YEAR2,ACTIVITY,ECONOMYrun);
...
*
equation TDC1_TotalDiscountedCostByTechnology(YEAR2,ACTIVITY,ECONOMYrun);
...
equation TCC1_TotalAnnualMaxCapacityConstraint(YEAR2,ACTIVITY,ECONOMYrun);
...
equation TCC2_TotalAnnualMinCapacityConstraint(YEAR2,ACTIVITY,ECONOMYrun);
...
*
equation NCC1_TotalAnnualMaxNewCapacityConstraint(YEAR2,ACTIVITY,ECONOMYrun);
...
equation NCC2_TotalAnnualMinNewCapacityConstraint(YEAR2,ACTIVITY,ECONOMYrun);
...
*
equation AAC1_TotalAnnualTechnologyActivity(YEAR2,ACTIVITY,ECONOMYrun);
...
equation AAC2_TotalAnnualTechnologyActivityUpperLimit(YEAR2,ACTIVITY,ECONOMYrun);
...
equation AAC3_TotalAnnualTechnologyActivityLowerLimit(YEAR2,ACTIVITY,ECONOMYrun);
...
*
equation TAC1_TotalModelHorizenTechnologyActivity(ACTIVITY,ECONOMYrun);
...
equation TAC2_TotalModelHorizenTechnologyActivityUpperLimit(YEAR2,ACTIVITY,ECONOMYrun);
...
equation TAC3_TotalModelHorizenTechnologyActivityLowerLimit(YEAR2,ACTIVITY,ECONOMYrun);
...
*
equation RM1_ReserveMargin_TechologiesIncluded_In_Activity_Units(YEAR2,TIMESLICE,ECONOMYrun);
...
equation RM2_ReserveMargin_FuelsIncluded(YEAR2,TIMESLICE,ECONOMYrun);
...
equation RM3_ReserveMargin_Constraint(YEAR2,TIMESLICE,ECONOMYrun);
...
*
equation RE1_FuelProductionByTechnologyAnnual(YEAR2,ACTIVITY,FLOW,ECONOMYrun);
...
*
equation E1_AnnualEmissionProductionByMode(YEAR2,ACTIVITY,EMISSION,MODE_OF_OPERATION,ECONOMYrun);
...
equation E2_AnnualEmissionProduction(YEAR2,ACTIVITY,EMISSION,ECONOMYrun);
...
equation E3_EmissionsPenaltyByTechAndEmission(YEAR2,ACTIVITY,EMISSION,ECONOMYrun);
...
equation E4_EmissionsPenaltyByTechnology(YEAR2,ACTIVITY,ECONOMYrun);
...
equation E5_DiscountedEmissionsPenaltyByTechnology(YEAR2,ACTIVITY,ECONOMYrun);
...
equation E6_EmissionsAccounting1(YEAR2,EMISSION,ECONOMYrun);
E6_EmissionsAccounting1(y,ghg,r).. sum(a, AnnualTechnologyEmission(y,a,ghg,r)) =e= AnnualEmissions(y,ghg,r);

equation E7_EmissionsAccounting2(EMISSION,ECONOMYrun);
